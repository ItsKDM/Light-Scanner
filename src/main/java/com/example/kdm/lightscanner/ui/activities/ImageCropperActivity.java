...
import com.example.kdm.lightscanner.async.LoadCallback;
import com.example.kdm.lightscanner.models.CroppedModel;
import com.example.kdm.lightscanner.ui.adapter.CroppedModelAdapter;
...
public class ImageCropperActivity extends BaseActivity {
    ...
    private com.isseiaoki.simplecropview.callback.LoadCallback loadCallback = new com.isseiaoki.simplecropview.callback.LoadCallback() {
        @Override
    ...
    private void crop() {
        ...
        mCropImageView.crop(Uri.fromFile(new File(path))).execute(new CropCallback() {
            ...
            public void onSuccess(Bitmap cropped) {
                ...
                Util.bitmapToFile(cropped, new File(selectedCroppedModel.path), new LoadCallback() {
                    @Override

...
import com.example.kdm.lightscanner.models.Preview;
import com.example.kdm.lightscanner.persistance.RepoManager;
import com.example.kdm.lightscanner.ui.adapter.PhotoPreviewAdapter;
import com.example.kdm.lightscanner.ui.base.BaseActivity;
import com.example.kdm.lightscanner.utils.L;
import com.example.kdm.lightscanner.utils.Util;
    ...
    class PdfCreatorTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                com.itextpdf.text.Document document = new Document(PageSize.A4, 20, 20, 20, 20);
                ...
                for (int i = 0; i < previewList.size(); i++) {
                    ...
                    com.itextpdf.text.Image image = Image.getInstance(byteArrayOutputStream.toByteArray());
